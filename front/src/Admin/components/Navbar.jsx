  ...
  return (
    <div className='bg-gray-800 px-4 py-3 flex justify-between '>
      <div className='flex items-center text-xl'>
        ...
        <span className='text-white font-semibold'>Pfe Gestion</span>
      </div>

      <div className='flex items-center gap-x-5'>
        <div className='relative md:w-65'>
          <span className='relative md:absolute inset-y-0 left-0 items-center pl-2'> 
         ...
         <div className='relative'>
          <button className='text-white group'>
            ...
            <div className='z-10 hidden bg-white absolute rounded-lg shadow w-32 group-focus:block to-full right-0'>
