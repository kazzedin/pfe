...
export default function EncadreurHomePage() {
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const { status, image,setImage,setStatus} = useContext(DataContext); // Correction : Destructurer correctement les valeurs de DataContext
  ...
  useEffect(()=>{
   axios.get(`http://localhost:3001/encadreur/getUser/${EncadreurUserEmail}`)
   .then(res=>{
        ...
        >
          ...
          <ul className="space-y-2 font-medium">
              ...
              <li onClick={toggleSidebar}>
                <Link to='/Encadreur/Docs' className="flex items-center p-2 text-black rounded-lg  hover:bg-gray-100  group" >
              ...
              <li onClick={toggleSidebar}>
                <Link to='/Encadreur/Inbox' className="flex items-center p-2 text-black rounded-lg  hover:bg-gray-100  group" >
              ...
              <li onClick={toggleSidebar}>
                <Link to='/Encadreur/Dates' className="flex items-center p-2 text-black rounded-lg  hover:bg-gray-100  group" >
              ...
              <li onClick={toggleSidebar}>
                <Link to='/Encadreur/Pfe' className="flex items-center p-2 text-black rounded-lg  hover:bg-gray-100  group" >
              ...
              <li onClick={toggleSidebar}>
                <Link to='/Encadreur/Encadreur' className="flex items-center p-2 text-black rounded-lg  hover:bg-gray-100 group" >
              ...
              <li onClick={toggleSidebar}>
                <Link to='/Encadreur/Chat' className="flex items-center p-2 text-black rounded-lg  hover:bg-gray-100 group" >
