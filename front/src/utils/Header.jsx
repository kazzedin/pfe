...
function Header() {
    ...
    return (
            ...
            <header className={`py-4 top-0 w-full z-50 bg-white `}>
                <nav className="mx-auto flex justify-between items-center">
                    <div className="flex items-center">
                        <Link to="/" className={`text-2xl font-bold ml-7  hover:text-blue-500`}>Pfe a Distance</Link>
                    </div>
                    <div className="hidden md:block mr-7">
                        <ul className="flex space-x-6 flex-row items-center">
                            <li><a href="#Login" className={`hover:text-blue-500  hover:border hover:border-blue-500 rounded-2xl p-1`}>Login</a></li>
                ...
                {isMenuOpen && (
                    <div className="md:hidden fixed top-0 right-0 mt-16 mr-4">
                        <div className={`bg-white w-64 rounded shadow-lg p-4`}>
                            <ul className="flex flex-col space-y-2">
                                <li><a href="#Login" className={`hover:text-blue-500 `} onClick={toggleMenu}>Login</a></li>
                                <li><a href="#Contact" className={`hover:text-blue-500 `} onClick={toggleMenu}>Contact</a></li>
                                <li><a href="#About" className={`hover:text-blue-500 `} onClick={toggleMenu}>A propos</a></li>
                                <li><a href="/Admin" className={`hover:text-blue-500 `} onClick={toggleMenu}>Admin</a></li>
                            </ul>
                        </div>
                    </div>
                )}
